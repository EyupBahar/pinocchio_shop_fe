...
const translations = {
  de: {
    ...
    // Product Form - Add/Edit Page
    features: 'Eigenschaften',
    featureType: 'Eigenschaftstyp',
    featureTypePlaceholder: 'Eigenschaftstyp (z.B. Versandinformationen)',
    featureTitle: 'Eigenschaftstitel',
    featureTitlePlaceholder: 'Eigenschaftstitel',
    featureDescription: 'Eigenschaftsbeschreibung',
    featureDescriptionPlaceholder: 'Eigenschaftsbeschreibung',
    adding: 'Wird hinzugefügt...',
    addFeature: 'Eigenschaft hinzufügen',
    updateFeature: 'Eigenschaft aktualisieren',
    edit: 'Bearbeiten',
    addSubstance: 'Hinzufügen',
    addSubstancePlaceholder: 'Stoffbeschreibung hinzufügen',
    featureTypeRequired: 'Eigenschaftstyp ist erforderlich',
    featureTypeAndTitleRequired: 'Eigenschaftstyp und Titel sind erforderlich',
    featureIdRequired: 'Eigenschafts-ID ist erforderlich. Bitte fügen Sie zuerst die Eigenschaft hinzu.',
    featureAddedSuccessfully: 'Eigenschaft erfolgreich hinzugefügt',
    failedToAddFeature: 'Fehler beim Hinzufügen der Eigenschaft',
    substanceAddedSuccessfully: 'Stoff erfolgreich hinzugefügt',
    failedToAddSubstance: 'Fehler beim Hinzufügen des Stoffes',
    sizeOptional: 'Größe (Optional)',
    selectSize: 'Größe auswählen',
    noSizeSelected: 'Keine Größe ausgewählt',
    addNewSizeScaleType: 'Neuen Größenmaßtyp hinzufügen',
    enterScaleType: 'Maßtyp eingeben (z.B. ml, gr, kg)',
    addScaleType: 'Maßtyp hinzufügen',
    addNewSize: 'Neue Größe hinzufügen',
    selectScaleType: 'Maßtyp auswählen',
    amountPlaceholder: 'Menge (z.B. 200, 300)',
    addSize: 'Größe hinzufügen',
    sizeScaleTypeRequired: 'Größenmaßtyp ist erforderlich',
    scaleTypeAndAmountRequired: 'Maßtyp und Menge sind erforderlich',
    scaleTypeIdRequired: 'Maßtyp-ID ist erforderlich',
    sizeScaleTypeAddedSuccessfully: 'Größenmaßtyp erfolgreich hinzugefügt',
    failedToAddSizeScaleType: 'Fehler beim Hinzufügen des Größenmaßtyps',
    sizeAddedSuccessfully: 'Größe erfolgreich hinzugefügt',
    failedToAddSize: 'Fehler beim Hinzufügen der Größe',
    imagePreview: 'Vorschau',
    imageUrlPlaceholder: 'https://example.com/image.jpg',
    confirmDeleteProduct: 'Möchten Sie dieses Produkt wirklich löschen?',
    productNotFound: 'Produkt nicht gefunden (ID: {id})',
    unauthorizedEditProduct: 'Nicht autorisiert. Bitte melden Sie sich an, um Produkte zu bearbeiten.',
    failedToLoadProduct: 'Fehler beim Laden des Produkts',
    fillRequiredFields: 'Bitte füllen Sie alle erforderlichen Felder aus (Titel, Beschreibung, Bild)',
    priceMustBeGreaterThanZero: 'Der Preis muss größer als 0 sein',
    categoryIdAndNameRequired: 'Kategorie-ID und Name sind erforderlich',
  },
  en: {
    // Navigation & General
    shop: 'Shop',
    ...
    featureTypePlaceholder: 'Feature Type (e.g., Shipping Information)',
    ...
    edit: 'Edit',
    addSubstance: 'Add',
    addSubstancePlaceholder: 'Add substance description',
    featureTypeRequired: 'Feature type is required',
    featureTypeAndTitleRequired: 'Feature type and title are required',
    featureIdRequired: 'Feature ID is required. Please add the feature first.',
    featureAddedSuccessfully: 'Feature added successfully',
    failedToAddFeature: 'Failed to add feature',
    substanceAddedSuccessfully: 'Substance added successfully',
    failedToAddSubstance: 'Failed to add substance',
    sizeOptional: 'Size (Optional)',
    selectSize: 'Select Size',
    noSizeSelected: 'No size selected',
    addNewSizeScaleType: 'Add New Size Scale Type',
    enterScaleType: 'Enter scale type (e.g., ml, gr, kg)',
    addScaleType: 'Add Scale Type',
    addNewSize: 'Add New Size',
    selectScaleType: 'Select scale type',
    amountPlaceholder: 'Amount (e.g., 200, 300)',
    addSize: 'Add Size',
    sizeScaleTypeRequired: 'Size scale type is required',
    scaleTypeAndAmountRequired: 'Both scale type and amount are required',
    scaleTypeIdRequired: 'Scale type ID is required',
    sizeScaleTypeAddedSuccessfully: 'Size scale type added successfully',
    failedToAddSizeScaleType: 'Failed to add size scale type',
    sizeAddedSuccessfully: 'Size added successfully',
    failedToAddSize: 'Failed to add size',
    imagePreview: 'Preview',
    imageUrlPlaceholder: 'https://example.com/image.jpg',
    confirmDeleteProduct: 'Are you sure you want to delete this product?',
    productNotFound: 'Product not found (ID: {id})',
    unauthorizedEditProduct: 'Unauthorized. Please login to edit products.',
    failedToLoadProduct: 'Failed to load product',
    fillRequiredFields: 'Please fill in all required fields (Title, Description, Image)',
    priceMustBeGreaterThanZero: 'Price must be greater than 0',
    categoryIdAndNameRequired: 'Category ID and name are required',
  },
  fr: {
    // Navigation & General
    shop: 'Boutique',
    ...
    featureTypePlaceholder: 'Type de caractéristique (ex: Informations d\'expédition)',
    featureTitle: 'Titre de la caractéristique',
    featureTitlePlaceholder: 'Titre de la caractéristique',
    featureDescription: 'Description de la caractéristique',
    featureDescriptionPlaceholder: 'Description de la caractéristique',
    adding: 'Ajout en cours...',
    addFeature: 'Ajouter une caractéristique',
    updateFeature: 'Mettre à jour la caractéristique',
    edit: 'Modifier',
    addSubstance: 'Ajouter',
    addSubstancePlaceholder: 'Ajouter une description de substance',
    featureTypeRequired: 'Le type de caractéristique est requis',
    featureTypeAndTitleRequired: 'Le type et le titre de la caractéristique sont requis',
    featureIdRequired: 'L\'ID de la caractéristique est requis. Veuillez d\'abord ajouter la caractéristique.',
    featureAddedSuccessfully: 'Caractéristique ajoutée avec succès',
    failedToAddFeature: 'Échec de l\'ajout de la caractéristique',
    substanceAddedSuccessfully: 'Substance ajoutée avec succès',
    failedToAddSubstance: 'Échec de l\'ajout de la substance',
    sizeOptional: 'Taille (Optionnel)',
    selectSize: 'Sélectionner la taille',
    noSizeSelected: 'Aucune taille sélectionnée',
    addNewSizeScaleType: 'Ajouter un nouveau type d\'échelle de taille',
    enterScaleType: 'Entrer le type d\'échelle (ex: ml, gr, kg)',
    addScaleType: 'Ajouter le type d\'échelle',
    addNewSize: 'Ajouter une nouvelle taille',
    selectScaleType: 'Sélectionner le type d\'échelle',
    amountPlaceholder: 'Quantité (ex: 200, 300)',
    addSize: 'Ajouter la taille',
    sizeScaleTypeRequired: 'Le type d\'échelle de taille est requis',
    scaleTypeAndAmountRequired: 'Le type d\'échelle et la quantité sont requis',
    scaleTypeIdRequired: 'L\'ID du type d\'échelle est requis',
    sizeScaleTypeAddedSuccessfully: 'Type d\'échelle de taille ajouté avec succès',
    failedToAddSizeScaleType: 'Échec de l\'ajout du type d\'échelle de taille',
    sizeAddedSuccessfully: 'Taille ajoutée avec succès',
    failedToAddSize: 'Échec de l\'ajout de la taille',
    imagePreview: 'Aperçu',
    imageUrlPlaceholder: 'https://example.com/image.jpg',
    confirmDeleteProduct: 'Êtes-vous sûr de vouloir supprimer ce produit?',
    productNotFound: 'Produit non trouvé (ID: {id})',
    unauthorizedEditProduct: 'Non autorisé. Veuillez vous connecter pour modifier les produits.',
    failedToLoadProduct: 'Échec du chargement du produit',
    fillRequiredFields: 'Veuillez remplir tous les champs obligatoires (Titre, Description, Image)',
    priceMustBeGreaterThanZero: 'Le prix doit être supérieur à 0',
    categoryIdAndNameRequired: 'L\'ID et le nom de la catégorie sont requis',
  },
  it: {
    // Navigation & General
    shop: 'Shop',
    ...
    featureType: 'Tipo di caratteristica',
    featureTypePlaceholder: 'Tipo di caratteristica (es: Informazioni di spedizione)',
    featureTitle: 'Titolo della caratteristica',
    featureTitlePlaceholder: 'Titolo della caratteristica',
    featureDescription: 'Descrizione della caratteristica',
    featureDescriptionPlaceholder: 'Descrizione della caratteristica',
    adding: 'Aggiunta in corso...',
    addFeature: 'Aggiungi caratteristica',
    updateFeature: 'Aggiorna caratteristica',
    edit: 'Modifica',
    addSubstance: 'Aggiungi',
    addSubstancePlaceholder: 'Aggiungi descrizione sostanza',
    featureTypeRequired: 'Il tipo di caratteristica è obbligatorio',
    featureTypeAndTitleRequired: 'Il tipo e il titolo della caratteristica sono obbligatori',
    featureIdRequired: 'L\'ID della caratteristica è obbligatorio. Si prega di aggiungere prima la caratteristica.',
    featureAddedSuccessfully: 'Caratteristica aggiunta con successo',
    failedToAddFeature: 'Errore nell\'aggiunta della caratteristica',
    substanceAddedSuccessfully: 'Sostanza aggiunta con successo',
    failedToAddSubstance: 'Errore nell\'aggiunta della sostanza',
    sizeOptional: 'Dimensione (Opzionale)',
    selectSize: 'Seleziona dimensione',
    noSizeSelected: 'Nessuna dimensione selezionata',
    addNewSizeScaleType: 'Aggiungi nuovo tipo di scala dimensionale',
    enterScaleType: 'Inserisci tipo di scala (es: ml, gr, kg)',
    addScaleType: 'Aggiungi tipo di scala',
    addNewSize: 'Aggiungi nuova dimensione',
    selectScaleType: 'Seleziona tipo di scala',
    amountPlaceholder: 'Quantità (es: 200, 300)',
    addSize: 'Aggiungi dimensione',
    sizeScaleTypeRequired: 'Il tipo di scala dimensionale è obbligatorio',
    scaleTypeAndAmountRequired: 'Sia il tipo di scala che la quantità sono obbligatori',
    scaleTypeIdRequired: 'L\'ID del tipo di scala è obbligatorio',
    sizeScaleTypeAddedSuccessfully: 'Tipo di scala dimensionale aggiunto con successo',
    failedToAddSizeScaleType: 'Errore nell\'aggiunta del tipo di scala dimensionale',
    sizeAddedSuccessfully: 'Dimensione aggiunta con successo',
    failedToAddSize: 'Errore nell\'aggiunta della dimensione',
    imagePreview: 'Anteprima',
    imageUrlPlaceholder: 'https://example.com/image.jpg',
    confirmDeleteProduct: 'Sei sicuro di voler eliminare questo prodotto?',
    productNotFound: 'Prodotto non trovato (ID: {id})',
    unauthorizedEditProduct: 'Non autorizzato. Si prega di accedere per modificare i prodotti.',
    failedToLoadProduct: 'Errore nel caricamento del prodotto',
    fillRequiredFields: 'Si prega di compilare tutti i campi obbligatori (Titolo, Descrizione, Immagine)',
    priceMustBeGreaterThanZero: 'Il prezzo deve essere maggiore di 0',
    categoryIdAndNameRequired: 'L\'ID e il nome della categoria sono obbligatori',
  },
}
