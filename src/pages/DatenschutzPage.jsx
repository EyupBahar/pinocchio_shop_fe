    ...
    <div className="container section" style={{ maxWidth: '900px', padding: '2rem 1rem' }}>
      ...
      <div style={{ lineHeight: '1.8', color: '#111827' }}>
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ marginBottom: '0.5rem' }}>
            <strong>Evren Haciömeroglu</strong><br />
            Flawilerstrasse 22<br />
            9242 Oberuzwil
          </p>
          <p style={{ marginBottom: '1rem' }}>
            Telefon: +41 71 9513651<br />
            E-Mail: info@pinocchio-oberuzwil.ch<br />
            WebSite: https://www.pinocchio-oberuzwil.ch/
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Ein genereller Widerspruch gegen den Einsatz der zu Zwecken des Onlinemarketing eingesetzten Cookies kann bei einer Vielzahl der Dienste, vor allem im Fall des Trackings, über die US-amerikanische Seite <a href="http://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" style={{ color: '#9B724C' }}>http://www.aboutads.info/choices/</a> oder die EU-Seite <a href="http://www.youronlinechoices.com/" target="_blank" rel="noopener noreferrer" style={{ color: '#9B724C' }}>http://www.youronlinechoices.com/</a> erklärt werden. Des Weiteren kann die Speicherung von Cookies mittels deren Abschaltung in den Einstellungen des Browsers erreicht werden. Bitte beachten Sie, dass dann gegebenenfalls nicht alle Funktionen dieses Onlineangebotes genutzt werden können.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Instagram: <a href="http://instagram.com/about/legal/privacy/" target="_blank" rel="noopener noreferrer" style={{ color: '#9B724C' }}>http://instagram.com/about/legal/privacy/</a>
          </p>
        </section>
